...
public class UnitData {
    ...
    @Transient
    private String allotmentOrder;

    @Transient
    private String lcsAgreement;

    @Transient
    private String a_bLoan;

    @Transient
    private String fieldMeasurementBook;

    @Transient
    private String handingoverReport;

    @Transient
    private String draftSaleDeed;

    @Column(name = "application_FILENAME")
    private String application_filename;

    @Column(name = "application_FILEPATH")
    private String application_filepath;

    @Column(name = "allotmentOrder_FILENAME")
    private String allotmentOrder_filename;

    @Column(name = "allotmentOrder_FILEPATH")
    private String allotmentOrder_filepath;

    @Column(name = "lcsAgreement_FILENAME")
    private String lcsAgreement_filename;

    @Column(name = "lcsAgreement_FILEPATH")
    private String lcsAgreement_filepath;

    @Column(name = "a_bLoan_FILENAME")
    private String a_bLoan_filename;

    @Column(name = "a_bLoan_FILEPATH")
    private String a_bLoan_filepath;

    @Column(name = "fieldMeasurementBook_FILENAME")
    private String fieldMeasurementBook_filename;

    @Column(name = "fieldMeasurementBook_FILEPATH")
    private String fieldMeasurementBook_filepath;

    @Column(name = "handingoverReport_FILENAME")
    private String handingoverReport_filename;

    @Column(name = "handingoverReport_FILEPATH")
    private String handingoverReport_filepath;

    @Column(name = "draftSaleDeed_FILENAME")
    private String draftSaleDeed_filename;

    @Column(name = "draftSaleDeed_FILEPATH")
    private String draftSaleDeed_filepath;
